...
export function Hero() {
  return (
    <section className="relative">
      <div className="mx-auto max-w-7xl px-6 pt-6 pb-12 sm:px-8 sm:pt-12 sm:pb-16 md:pt-20 md:pb-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          {/* Trust bar — 7건 클라이언트 */}
          <div className="mx-auto mt-10 max-w-3xl border-t border-gray-100 pt-6 sm:mt-12 sm:pt-8">
