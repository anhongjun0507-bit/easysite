...
export const ISONITE_TF1 = {
  ...
  /** 강조 문장 — isonite 상세에서 pull-quote로 부각 */
  pullQuote: '표면 화합물층과 압축 잔류응력이 마모와 피로를 동시에 억제해, 변형 없이 부품의 수명을 끌어올립니다.',
  /** 대표 적용 부품 — 비주얼 카드(크랭크샤프트·엔진 밸브·기어류) */
  applicationsFeatured: [
    { name: '크랭크샤프트', desc: '반복 굽힘·비틀림 하중을 받는 엔진의 핵심 회전축', img: IMG.parts },
    { name: '엔진 밸브', desc: '고온·마모 환경에서 밀폐를 유지하는 왕복 구동 부품', img: IMG.autos },
    { name: '기어류', desc: '치면 접촉 마모와 피로에 노출되는 동력 전달 부품', img: IMG.autoline },
  ],
